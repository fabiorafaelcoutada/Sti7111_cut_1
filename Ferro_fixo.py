...
def main():
    ...
    parser.add_argument('--write-timeout', type=float, default=0.5, help='Write timeout in seconds (default: 0.5)')
    args = parser.parse_args()

    s = serial.Serial(args.port, args.baud, write_timeout=args.write_timeout)
