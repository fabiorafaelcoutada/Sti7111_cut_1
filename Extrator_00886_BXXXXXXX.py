...
def extract_header(data):
	header = {}
	header['DESCRIPTOR'] = data[0:4].hex().upper()
	header['NUID'] = data[4:8].hex().upper()
	header['NPROVIDER'] = data[8:10].hex().upper()
	header['PROVIDERID'] = data[10:12].hex().upper()
	header['ARCH'] = data[12:14].hex().upper()
	header['CWKEYDESC'] = data[14:15].hex().upper()
	header['TLENGHT'] = data[17:18].hex().upper()
	header['Hextable'] = data[18:19].hex().upper()
	return header
...
if __name__ == "__main__":
	...
	NUID = header['NUID']
	NPROVIDER = header['NPROVIDER']
	PROVIDERID = header['PROVIDERID']
	ARCH = header['ARCH']
	CWKEYDESC = header['CWKEYDESC']
	Hextable = header['Hextable']
	TLENGHT = header['TLENGHT']

	BLOCK = data[19:153].hex().upper()

	eCK0 = data[19:35].hex().upper()
	eCK1 = data[35:51].hex().upper()
	eCK2 = data[51:67].hex().upper()
	eCK3 = data[67:83].hex().upper()
	eCK4 = data[83:99].hex().upper()
	eCK5 = data[99:115].hex().upper()
	eCK6 = data[115:131].hex().upper()
	eCK7 = data[131:147].hex().upper()
	print()
	...
	tab = "    "
	block0583_1 = 140
	block0583 = data[147:149].hex().upper()
	subkey8A0010 = data[149:153].hex().upper()
	subkey8A_256 = data[152:280].hex().upper()
	...
	BB0583_1 = 280
	block0583_1 = data[BB0583_1:(BB0583_1 + 2)].hex().upper()
	subkey9A1020 = data[(BB0583_1 + 2):(BB0583_1 + 5)].hex().upper()
	subkey8A0100 = data[(BB0583_1 + 5):((BB0583_1 + 5) + 132)].hex().upper()
	...
	BB0583_2 = 413
	block0583_2 = data[BB0583_2:(BB0583_2 + 2)].hex().upper()
	subkey901020 = data[(BB0583_2 + 2):(BB0583_2 + 5)].hex().upper()
	subkeyD00100 = data[(BB0583_2 + 5):((BB0583_2 + 5) + 132)].hex().upper()
	...
	BB0583_3 = 546
	block0583_3 = data[BB0583_3:(BB0583_3 + 2)].hex().upper()
	subkey991020 = data[(BB0583_3 + 2):(BB0583_3 + 5)].hex().upper()
	subkey990100 = data[(BB0583_3 + 5):((BB0583_3 + 5) + 132)].hex().upper()
	...
	BB0583_4 = 679
	block0583_4 = data[BB0583_4:(BB0583_4 + 2)].hex().upper()
	subkey981020 = data[(BB0583_4 + 2):(BB0583_4 + 5)].hex().upper()
	subkey880100 = data[(BB0583_4 + 5):((BB0583_4 + 5) + 132)].hex().upper()
	...
	BB0583_5 = 812
	block0583_5 = data[BB0583_5:(BB0583_5 + 2)].hex().upper()
	subkeyAA2020 = data[(BB0583_5 + 2):(BB0583_5 + 5)].hex().upper()
	subkey8A0200 = data[(BB0583_5 + 5):((BB0583_5 + 5) + 132)].hex().upper()
	...
	BB0583_6 = 945
	block0583_6 = data[BB0583_6:(BB0583_6 + 2)].hex().upper()
	subkeyA02020 = data[(BB0583_6 + 2):(BB0583_6 + 5)].hex().upper()
	subkeyD00200 = data[(BB0583_6 + 5):((BB0583_6 + 5) + 132)].hex().upper()
	...
	BBBB0583_7 = 1078
	blockBB0583_7 = data[BBBB0583_7:(BBBB0583_7 + 2)].hex().upper()
	subkeyA92020 = data[(BBBB0583_7 + 2):(BBBB0583_7 + 5)].hex().upper()
	subkey990200 = data[(BBBB0583_7 + 5):((BBBB0583_7 + 5) + 132)].hex().upper()
	...
	BBBB0583_8 = 1211
	blockBB0583_8 = data[BBBB0583_8:(BBBB0583_8 + 2)].hex().upper()
	subkeyA82020 = data[(BBBB0583_8 + 2):(BBBB0583_8 + 5)].hex().upper()
	subkey880200 = data[(BBBB0583_8 + 5):((BBBB0583_8 + 5) + 132)].hex().upper()
	...
	BB0323 = 1344
	block0323 = data[BB0323:(BB0323 + 2)].hex().upper()
	subkey010E10 = data[(BB0323 + 2):(BB0323 + 5)].hex().upper()
	subkey010E = data[(BB0323 + 5):((BB0323 + 5) + 32)].hex().upper()
	...
	BB0622 = 1381
	block0622 = data[BB0622:(BB0622 + 2)].hex().upper()
	subkey811000 = data[(BB0622 + 2):(BB0622 + 4)].hex().upper()
	subkey8110 = data[(BB0622 + 4):((BB0622 + 4) + 32)].hex().upper()
	...
	BB0436 = 1417
	block0436 = data[BB0436:(BB0436 + 2)].hex().upper()
	subkey000010 = data[(BB0436 + 2):(BB0436 + 5)].hex().upper()
	subkeyXX0000 = data[(BB0436 + 5):((BB0436 + 5) + 51)].hex().upper()
	...
	BB0746 = 1473
	block0746 = data[BB0746:(BB0746 + 2)].hex().upper()
	subkey8A10 = data[(BB0746 + 2):(BB0746 + 4)].hex().upper()
	subkeyXX8A10 = data[(BB0746 + 4):((BB0746 + 4) + 68)].hex().upper()
	...
	BB0724 = 1545
	block0724 = data[BB0724:(BB0724 + 2)].hex().upper()
	subkey8010 = data[(BB0724 + 2):(BB0724 + 4)].hex().upper()
	subkeyXX8010 = data[(BB0724 + 4):((BB0724 + 4) + 68)].hex().upper()
	...
	BB0744_0 = 1583
	block0744_0 = data[BB0744_0:(BB0744_0 + 2)].hex().upper()
	subkey9A20 = data[(BB0744_0 + 2):(BB0744_0 + 4)].hex().upper()
	subkey8A0100 = data[(BB0744_0 + 4):((BB0744_0 + 4) + 132)].hex().upper()
	...
	BB0744_1 = 1653
	block0744_1 = data[BB0744_1:(BB0744_1 + 2)].hex().upper()
	subkey9020 = data[(BB0744_1 + 2):(BB0744_1 + 4)].hex().upper()
	subkeyD00100 = data[(BB0744_1 + 4):((BB0744_1 + 4) + 68)].hex().upper()
	...
	BB0744_2 = 1723
	block0744_2 = data[BB0744_2:(BB0744_2 + 2)].hex().upper()
	subkey9920 = data[(BB0744_2 + 2):(BB0744_2 + 4)].hex().upper()
	subkey990100 = data[(BB0744_2 + 4):((BB0744_2 + 4) + 68)].hex().upper()
	...
	BB0744_3 = 1793
	block0744_3 = data[BB0744_3:(BB0744_3 + 2)].hex().upper()
	subkey9820 = data[(BB0744_3 + 2):(BB0744_3 + 4)].hex().upper()
	subkey8801300 = data[(BB0744_3 + 4):((BB0744_3 + 4) + 68)].hex().upper()
	...
	BB0744_4 = 1863
	block0744_4 = data[BB0744_4:(BB0744_4 + 2)].hex().upper()
	subkeyBA20 = data[(BB0744_4 + 2):(BB0744_4 + 4)].hex().upper()
	subkey8A0300 = data[(BB0744_4 + 4):((BB0744_4 + 4) + 132)].hex().upper()
	...
	BB0744_5 = 1933
	block0744_5 = data[BB0744_5:(BB0744_5 + 2)].hex().upper()
	subkeyB920 = data[(BB0744_5 + 2):(BB0744_5 + 4)].hex().upper()
	subkey9903300 = data[(BB0744_5 + 4):((BB0744_5 + 4) + 132)].hex().upper()
	...
	BB0744_6 = 2003
	block0744_6 = data[BB0744_6:(BB0744_6 + 2)].hex().upper()
	subkeyB820 = data[(BB0744_6 + 2):(BB0744_6 + 4)].hex().upper()
	subkey980300 = data[(BB0744_6 + 4):((BB0744_6 + 4) + 132)].hex().upper()
	...
	BB0744_7 = 2073
	block0744_7 = data[BB0744_7:(BB0744_7 + 2)].hex().upper()
	subkeyB820 = data[(BB0744_7 + 2):(BB0744_7 + 4)].hex().upper()
	subkey880300 = data[(BB0744_7 + 4):((BB0744_7 + 4) + 132)].hex().upper()
	...
	BB0904 = 2143
	block0904 = data[BB0904:(BB0904 + 2)].hex().upper()
	subkey0304 = data[(BB0904 + 2):(BB0904 + 4)].hex().upper()
	subkey010400 = data[(BB0904 + 4):((BB0904 + 4) + 137)].hex().upper()
