...
DESCRIPTOR = data[0:4].hex().upper()
NUID = data[4:8].hex().upper()
NPROVIDER = data[8:10].hex().upper()
PROVIDERID = data[10:12].hex().upper()
ARCH = data[12:14].hex().upper()
CWKEYDESC = data[14:15].hex().upper()
Hextable = data[18:19].hex().upper()
TLENGHT = data[17:18].hex().upper()

BLOCK = data[19:153].hex()
