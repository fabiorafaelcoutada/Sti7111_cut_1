...
if filename0 not in f:
	print("Error: Invalid file selection. Please choose a file from the list.")
	sys.exit(1)
...
DESCRIPTOR = binascii.hexlify(data[0:4]).decode("ascii").upper()
NUID = binascii.hexlify(data[4:8]).decode("ascii").upper()
NPROVIDER = binascii.hexlify(data[8:10]).decode("ascii").upper()
PROVIDERID = binascii.hexlify(data[10:12]).decode("ascii").upper()
ARCH = binascii.hexlify(data[12:14]).decode("ascii").upper()
CWKEYDESC = binascii.hexlify(data[14:15]).decode("ascii").upper()
Hextable = binascii.hexlify(data[18:19]).decode("ascii").upper()
TLENGHT = binascii.hexlify(data[17:18]).decode("ascii").upper()

BLOCK = binascii.hexlify(data[19:153]).decode("ascii")

eCK0 = binascii.hexlify(data[19:35]).decode("ascii").upper()
eCK1 = binascii.hexlify(data[35:51]).decode("ascii").upper()
eCK2 = binascii.hexlify(data[51:67]).decode("ascii").upper()
eCK3 = binascii.hexlify(data[67:83]).decode("ascii").upper()
eCK4 = binascii.hexlify(data[83:99]).decode("ascii").upper()
eCK5 = binascii.hexlify(data[99:115]).decode("ascii").upper()
eCK6 = binascii.hexlify(data[115:131]).decode("ascii").upper()
eCK7 = binascii.hexlify(data[131:147]).decode("ascii").upper()
print()
...
tab = "    "
block0583_1 = 140
block0583 = binascii.hexlify(data[147:149]).decode("ascii").upper()
subkey8A0010 = binascii.hexlify(data[149:153]).decode("ascii").upper()
subkey8A_256 = binascii.hexlify(data[152:280]).decode("ascii").upper()
...
BB0583_1 = 280
block0583_1 = binascii.hexlify(data[BB0583_1:(BB0583_1 + 2)]).decode("ascii").upper()
subkey9A1020 = binascii.hexlify(data[(BB0583_1 + 2):(BB0583_1 + 5)]).decode("ascii").upper()
subkey8A0100 = binascii.hexlify(data[(BB0583_1 + 5):((BB0583_1 + 5) + 132)]).decode("ascii").upper()
...
BB0583_2 = 413
block0583_2 = binascii.hexlify(data[BB0583_2:(BB0583_2 + 2)]).decode("ascii").upper()
subkey901020 = binascii.hexlify(data[(BB0583_2 + 2):(BB0583_2 + 5)]).decode("ascii").upper()
subkeyD00100 = binascii.hexlify(data[(BB0583_2 + 5):((BB0583_2 + 5) + 132)]).decode("ascii").upper()
...
BB0583_3 = 546
block0583_3 = binascii.hexlify(data[BB0583_3:(BB0583_3 + 2)]).decode("ascii").upper()
subkey991020 = binascii.hexlify(data[(BB0583_3 + 2):(BB0583_3 + 5)]).decode("ascii").upper()
subkey990100 = binascii.hexlify(data[(BB0583_3 + 5):((BB0583_3 + 5) + 132)]).decode("ascii").upper()
...
BB0583_4 = 679
block0583_4 = binascii.hexlify(data[BB0583_4:(BB0583_4 + 2)]).decode("ascii").upper()
subkey981020 = binascii.hexlify(data[(BB0583_4 + 2):(BB0583_4 + 5)]).decode("ascii").upper()
subkey880100 = binascii.hexlify(data[(BB0583_4 + 5):((BB0583_4 + 5) + 132)]).decode("ascii").upper()
...
BB0583_5 = 812
block0583_5 = binascii.hexlify(data[BB0583_5:(BB0583_5 + 2)]).decode("ascii").upper()
subkeyAA2020 = binascii.hexlify(data[(BB0583_5 + 2):(BB0583_5 + 5)]).decode("ascii").upper()
subkey8A0200 = binascii.hexlify(data[(BB0583_5 + 5):((BB0583_5 + 5) + 132)]).decode("ascii").upper()
...
BB0583_6 = 945
block0583_6 = binascii.hexlify(data[BB0583_6:(BB0583_6 + 2)]).decode("ascii").upper()
subkeyA02020 = binascii.hexlify(data[(BB0583_6 + 2):(BB0583_6 + 5)]).decode("ascii").upper()
subkeyD00200 = binascii.hexlify(data[(BB0583_6 + 5):((BB0583_6 + 5) + 132)]).decode("ascii").upper()
...
BBBB0583_7 = 1078
blockBB0583_7 = binascii.hexlify(data[BBBB0583_7:(BBBB0583_7 + 2)]).decode("ascii").upper()
subkeyA92020 = binascii.hexlify(data[(BBBB0583_7 + 2):(BBBB0583_7 + 5)]).decode("ascii").upper()
subkey990200 = binascii.hexlify(data[(BBBB0583_7 + 5):((BBBB0583_7 + 5) + 132)]).decode("ascii").upper()
...
BBBB0583_8 = 1211
blockBB0583_8 = binascii.hexlify(data[BBBB0583_8:(BBBB0583_8 + 2)]).decode("ascii").upper()
subkeyA82020 = binascii.hexlify(data[(BBBB0583_8 + 2):(BBBB0583_8 + 5)]).decode("ascii").upper()
subkey880200 = binascii.hexlify(data[(BBBB0583_8 + 5):((BBBB0583_8 + 5) + 132)]).decode("ascii").upper()
...
BB0323 = 1344
block0323 = binascii.hexlify(data[BB0323:(BB0323 + 2)]).decode("ascii").upper()
subkey010E10 = binascii.hexlify(data[(BB0323 + 2):(BB0323 + 5)]).decode("ascii").upper()
subkey010E = binascii.hexlify(data[(BB0323 + 5):((BB0323 + 5) + 32)]).decode("ascii").upper()
...
BB0622 = 1381
block0622 = binascii.hexlify(data[BB0622:(BB0622 + 2)]).decode("ascii").upper()
subkey811000 = binascii.hexlify(data[(BB0622 + 2):(BB0622 + 4)]).decode("ascii").upper()
subkey8110 = binascii.hexlify(data[(BB0622 + 4):((BB0622 + 4) + 32)]).decode("ascii").upper()
...
BB0436 = 1417
block0436 = binascii.hexlify(data[BB0436:(BB0436 + 2)]).decode("ascii").upper()
subkey000010 = binascii.hexlify(data[(BB0436 + 2):(BB0436 + 5)]).decode("ascii").upper()
subkeyXX0000 = binascii.hexlify(data[(BB0436 + 5):((BB0436 + 5) + 51)]).decode("ascii").upper()
...
BB0746 = 1473
block0746 = binascii.hexlify(data[BB0746:(BB0746 + 2)]).decode("ascii").upper()
subkey8A10 = binascii.hexlify(data[(BB0746 + 2):(BB0746 + 4)]).decode("ascii").upper()
subkeyXX8A10 = binascii.hexlify(data[(BB0746 + 4):((BB0746 + 4) + 68)]).decode("ascii").upper()
...
BB0724 = 1545
block0724 = binascii.hexlify(data[BB0724:(BB0724 + 2)]).decode("ascii").upper()
subkey8010 = binascii.hexlify(data[(BB0724 + 2):(BB0724 + 4)]).decode("ascii").upper()
subkeyXX8010 = binascii.hexlify(data[(BB0724 + 4):((BB0724 + 4) + 68)]).decode("ascii").upper()
...
BB0744_0 = 1583
block0744_0 = binascii.hexlify(data[BB0744_0:(BB0744_0 + 2)]).decode("ascii").upper()
subkey9A20 = binascii.hexlify(data[(BB0744_0 + 2):(BB0744_0 + 4)]).decode("ascii").upper()
subkey8A0100 = binascii.hexlify(data[(BB0744_0 + 4):((BB0744_0 + 4) + 132)]).decode("ascii").upper()
...
BB0744_1 = 1653
block0744_1 = binascii.hexlify(data[BB0744_1:(BB0744_1 + 2)]).decode("ascii").upper()
subkey9020 = binascii.hexlify(data[(BB0744_1 + 2):(BB0744_1 + 4)]).decode("ascii").upper()
subkeyD00100 = binascii.hexlify(data[(BB0744_1 + 4):((BB0744_1 + 4) + 68)]).decode("ascii").upper()
...
BB0744_2 = 1723
block0744_2 = binascii.hexlify(data[BB0744_2:(BB0744_2 + 2)]).decode("ascii").upper()
subkey9920 = binascii.hexlify(data[(BB0744_2 + 2):(BB0744_2 + 4)]).decode("ascii").upper()
subkey990100 = binascii.hexlify(data[(BB0744_2 + 4):((BB0744_2 + 4) + 68)]).decode("ascii").upper()
...
BB0744_3 = 1793
block0744_3 = binascii.hexlify(data[BB0744_3:(BB0744_3 + 2)]).decode("ascii").upper()
subkey9820 = binascii.hexlify(data[(BB0744_3 + 2):(BB0744_3 + 4)]).decode("ascii").upper()
subkey8801300 = binascii.hexlify(data[(BB0744_3 + 4):((BB0744_3 + 4) + 68)]).decode("ascii").upper()
...
BB0744_4 = 1863
block0744_4 = binascii.hexlify(data[BB0744_4:(BB0744_4 + 2)]).decode("ascii").upper()
subkeyBA20 = binascii.hexlify(data[(BB0744_4 + 2):(BB0744_4 + 4)]).decode("ascii").upper()
subkey8A0300 = binascii.hexlify(data[(BB0744_4 + 4):((BB0744_4 + 4) + 132)]).decode("ascii").upper()
...
BB0744_5 = 1933
block0744_5 = binascii.hexlify(data[BB0744_5:(BB0744_5 + 2)]).decode("ascii").upper()
subkeyB920 = binascii.hexlify(data[(BB0744_5 + 2):(BB0744_5 + 4)]).decode("ascii").upper()
subkey9903300 = binascii.hexlify(data[(BB0744_5 + 4):((BB0744_5 + 4) + 132)]).decode("ascii").upper()
...
BB0744_6 = 2003
block0744_6 = binascii.hexlify(data[BB0744_6:(BB0744_6 + 2)]).decode("ascii").upper()
subkeyB820 = binascii.hexlify(data[(BB0744_6 + 2):(BB0744_6 + 4)]).decode("ascii").upper()
subkey980300 = binascii.hexlify(data[(BB0744_6 + 4):((BB0744_6 + 4) + 132)]).decode("ascii").upper()
...
BB0744_7 = 2073
block0744_7 = binascii.hexlify(data[BB0744_7:(BB0744_7 + 2)]).decode("ascii").upper()
subkeyB820 = binascii.hexlify(data[(BB0744_7 + 2):(BB0744_7 + 4)]).decode("ascii").upper()
subkey880300 = binascii.hexlify(data[(BB0744_7 + 4):((BB0744_7 + 4) + 132)]).decode("ascii").upper()
...
BB0904 = 2143
block0904 = binascii.hexlify(data[BB0904:(BB0904 + 2)]).decode("ascii").upper()
subkey0304 = binascii.hexlify(data[(BB0904 + 2):(BB0904 + 4)]).decode("ascii").upper()
subkey010400 = binascii.hexlify(data[(BB0904 + 4):((BB0904 + 4) + 137)]).decode("ascii").upper()
